...
(defface powerline-active1 '((t (:background "#FF9800" :foreground "black" :inherit mode-line)))
  "Powerline face 1."
  :group 'powerline)

(defface powerline-active2 '((t (:background "#607D8B" :foreground "white" :inherit mode-line)))
  "Powerline face 2."
  :group 'powerline)
